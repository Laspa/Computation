...
# Emily Hwang
# May 22, 2018
# Script to extract elastic tensor and calculate various values
# ==============================================================
...
print "C11 in GPa is: " + str(C11/10)
print "C12 in GPa is: " + str(C12/10)
print "C44 in GPa is: " + str(C44/10)
